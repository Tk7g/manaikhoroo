...
<div id="mainComponent">
	...
	<div class="mainWrapper">
		...
		<a href="order.php?page=1&status=0&company=&product=" class="notification-link">
		...
		<a href="order.php?page=1&status=1&company=&product=" class="notification-link">
		<div class="notification-block">
		...
		<a href="order.php?page=1&status=2&company=&product=" class="notification-link">
		<div class="notification-block">
		...
		<a href="order.php?page=1&status=4&company=&product=" class="notification-link">
		<div class="notification-block">
		...
		<a href="order.php?page=1&status=5&company=&product=" class="notification-link">
		<div class="notification-block">
		...
		<a href="order.php?page=1&status=6&company=&product=" class="notification-link">
		<div class="notification-block">
		...
		<div class="orderIconBody">
		<a href="directOrder.php?page=1&status=0&product=" class="notification-link">
		...
		<a href="directOrder.php?page=1&status=1&product=" class="notification-link">
		...
		<a href="directOrder.php?page=1&status=2&product=" class="notification-link">
		...
		<a href="directOrder.php?page=1&status=4&product=" class="notification-link">
		...
		<a href="directOrder.php?page=1&status=5&product=" class="notification-link">
		...
		<a href="directOrder.php?page=1&status=6&product=" class="notification-link">
							...
							<div class="row">
								...
								<div class="medium-4 columns">
									<div class="orderDetailReadmore">
										<a href="order.php?action=orderInfo&id=<?php echo $cOrder['id']; ?>">Дэлгэрэнгүй</a>
									</div>
								</div>
							</div>
						</div>
					...
					<?php foreach($directOrders as $dOrder) : ?>
						<div class="orderDetailRow">
							<div class="row">
								...
								<div class="medium-4 columns">
									<div class="orderDetailReadmore">
										<a href="directOrder.php?action=orderInfo&id=<?php echo $dOrder['id']; ?>">Дэлгэрэнгүй</a>
									</div>
								</div>
							</div>
						</div>
