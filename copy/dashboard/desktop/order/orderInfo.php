							...
							<div class="orderInfoBlockRow" style="border-bottom: none; border-top: none;">
								<div class="row">
									<div class="medium-12 columns">
        								...
        								<input type="text" name="payment2" id="Payment2" value="0" required="required"/>
        								<label>Бартерын дүн (₮)</label>
										<input type="text" id="Barter" name="barter" value="0" />
        								<div class="text-center">
  ...
  calTotalPrice();
				...
				?>
					<div class="orderInfoBlock">
						...
						<div class="orderInfoBlockDetail">
							<div class="orderInfoBlockRow text-justify" style="border-top: none;">
								<span class="orderInfoFullStatusIcon" style="background: <?php echo getStatusColor($order['status']); ?>;"></span> - Захиалгын зөвшөөрлийг хүлээж байна.
							</div>
						</div>
						<div class="orderInfoBlockTitle">
							Гэрээний мэдээлэл
						...
						<div class="orderInfoBlockDetail">
							<div class="orderInfoBlockRow" style="border-top: none; border-bottom: none;">
								<div class="row">
									<div class="medium-6 columns">
										<a href="order.php?action=approveOrder&id=<?php echo $order['id']; ?>" class="button tiny expand yellowBtn" onclick="return confirm('Захиалгыг зөвшөөрөх үү?');">Зөвшөөрөх</a>
									</div>
									<div class="medium-6 columns">
