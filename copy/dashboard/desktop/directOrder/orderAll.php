	...
	<div class="mainWrapper">
		...
		<table width="100%" class="orderTable">
			...
			<tr>
				...
				<td>
					<a href="directOrder.php?action=orderInfo&id=<?php echo $order['id']; ?>"><?php echo $order['company_name']; ?></a>
		...
		<div id="paginationBlock">
			<?php for($i=1; $i<=$total_pagination; $i++) { ?>
				<?php if(isset($_GET['status'])) { ?>
					<a class="paginationLink" href="directOrder.php?page=<?php echo $i; ?>&status=<?php echo $_GET['status']; ?>&product=<?php echo $_GET['product']; ?>"><?php echo $i; ?></a>
				<?php } else { ?>
				<a class="paginationLink" href="directOrder.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
				<?php } ?>
			<?php } ?>
		</div>
	</div>
