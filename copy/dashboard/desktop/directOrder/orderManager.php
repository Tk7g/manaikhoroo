...
<div id="mainComponent">
	...
	<div class="mainWrapper">
		...
		<div class="searchBlock">
				<form action="directOrder.php?action=searchOrderManager" method="post">
			<div class="row">
		...
		<table width="100%" class="orderTable">
			...
			<tr>
				...
				<td>
					<a href="directOrder.php?action=orderInfoManager&id=<?php echo $order['id']; ?>"><?php echo $order['company_name']; ?></a>
		...
		<div id="paginationBlock">
			<?php for($i=1; $i<=$total_pagination; $i++) { ?>
				<?php if(isset($_GET['status'])) { ?>
					<a class="paginationLink" href="directOrder.php?action=orderManager&page=<?php echo $i; ?>&status=<?php echo $_GET['status']; ?>&product=<?php echo $_GET['product']; ?>"><?php echo $i; ?></a>
				<?php } else { ?>
				<a class="paginationLink" href="directOrder.php?action=orderManager&page=<?php echo $i; ?>"><?php echo $i; ?></a>
				<?php } ?>
			<?php } ?>
		</div>
	</div>
