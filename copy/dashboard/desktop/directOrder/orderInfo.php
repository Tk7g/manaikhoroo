...
$("#Price").change(function() {
  calculateTotal();
						...
						<div class="orderInfoBlockDetail">
							<div class="row">
								<div style="padding-top: 15px;" class="medium-6 medium-centered columns">
									<a href="directOrder.php?action=cancelOrder&id=<?php echo $order['id']; ?>" class="button tiny alert expand" onclick="return confirm('Захиалгаас татгалзах уу?');">Татгалзах</a>
								</div>
							</div>
						</div>
					</div>
				...
				?>
					<div class="orderInfoBlock">
						...
						<div class="orderInfoBlockTitle">
							Захиалгыг зөвшөөрөх эсэх
						</div>
						<div class="orderInfoBlockDetail">
							<div class="orderInfoBlockRow" style="border-top: none; border-bottom: none;">
								<div class="row">
									<div class="medium-6 columns">
										<a href="directOrder.php?action=approveOrder&id=<?php echo $order['id']; ?>" class="button tiny expand yellowBtn" onclick="return confirm('Захиалгыг зөвшөөрөх үү?');">Зөвшөөрөх</a>
									</div>
									<div class="medium-6 columns">
										<a href="directOrder.php?action=cancelOrder&id=<?php echo $order['id']; ?>" class="button tiny alert expand" onclick="return confirm('Захиалгыг татгалзах уу?');">Татгалзах</a>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="orderInfoBlockDetail">
							<form action="directOrder.php?action=descSubmit" method="post">
							<input type="hidden" name="id" value="<?php echo $_GET['id']; ?>" id="ID" />
							<div class="orderInfoBlockRow" style="border-bottom: none; border-top: none;">
								<div class="row">
									<div class="medium-12 columns">
				...
				?>
					<div class="orderInfoBlock">
						...
						<div class="orderInfoBlockDetail">
							<div class="row">
								<div style="padding-top: 15px;" class="medium-6 medium-centered columns">
									<a href="order.php?action=cancelOrder&id=<?php echo $order['id']; ?>" class="button tiny alert expand" onclick="return confirm('Захиалгаас татгалзах уу?');">Татгалзах</a>
								</div>
							</div>
						</div>
<script>
