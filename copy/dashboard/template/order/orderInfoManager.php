					...
					<li class="accordion-navigation">
						...
						<div id="panel1a" class="content active">
							<div class="orderInfoFullProcedure">
								<div class="row">
									<div class="small-12 columns">
										<span class="orderInfoFullStatusIcon" style="background: <?php echo getStatusColor($order['status']); ?>;"></span> - Захиалгад гэрээний дугаар олгон, бүтээгдэхүүний үнийг тооцон, гэрээг хавсарган захирал руу илгээсэн байна. Одоогоор захирлын зөвшөөрлийг хүлээж байна.
									</div>
								</div>
							</div>
						</div>
						...
						<div id="panel2a" class="content">
							...
							<div class="orderInfoFullRow">
								<div class="row">
									...
									<div class="small-6 columns text-right orderInfoFullInfo">
										<?php echo $order['total_price']; ?> м<sup>3</sup>
									</div>
								</div>
							</div>
							<div class="orderInfoFullRow">
		...
		?>
			...
			<div class="orderInfoFullBody">
				<ul class="accordion" data-accordion>
					<li class="accordion-navigation">
						...
						<div id="panel1a" class="content active">
							<div class="orderInfoFullProcedure">
								<div class="row">
									<div class="small-12 columns">
										<span class="orderInfoFullStatusIcon" style="background: <?php echo getStatusColor($order['status']); ?>;"></span> - Захиалгын гэрээг зөвшөөрсөн тул тань руу шилжсэн байна. Тухайн компанитай гэрээ байгуулж, төлбөрийг хүлээн аван үйлдвэр рүү шилжүүлэхийг хүлээж байна.
									</div>
								</div>
							</div>
							<div class="orderInfoFullRow">
					...
					<li class="accordion-navigation">
						<a href="#panel3a" class="orderInfoFullTitle">Төлбөрийн мэдээлэл оруулах</a>
				...
				<ul class="accordion" data-accordion>
					...
					<li class="accordion-navigation">
						...
						<div id="panel3a" class="content">
							<div class="row">
								<div class="small-12 columns">
									<form action="order.php?action=paymentChange" method="post" enctype="multipart/form-data">
										<input type="hidden" name="id" value="<?php echo $order['id']; ?>" />
										<div class="orderInfoFormRow">
											<div class="row">
												<div class="small-12 columns">
										...
										<div class="row">
    										<div class="large-12 columns text-center">
    											<button type="submit" name="saveOrder" class="infoFormSubmit">Төлбөрийн мэдээлэл өөрчлөх</button>
    										</div>
    									</div>
									</form>
								</div>
		...
		?>
			...
			<div class="orderInfoFullBody">
				<ul class="accordion" data-accordion>
					...
					<li class="accordion-navigation">
						<a href="#panel4a" class="orderInfoFullTitle">Төлбөрийн мэдээлэл оруулах</a>
