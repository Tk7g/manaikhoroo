...
<div id="page-block">
	<div class="row">
		...
		<?php for($i=1; $i<=$total_pagination; $i++) { ?>
			...
			<a class="pagination-link" href="order.php?page=<?php echo $i; ?>&status=<?php echo $_GET['status']; ?>"><?php echo $i; ?></a>
			<?php } else { ?>
			<a class="pagination-link" href="order.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
			<?php } ?>
		<?php } ?>
		</div>
	</div>
