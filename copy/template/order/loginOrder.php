	...
	<div class="row small-collapse large-collapse">
		...
		<div class="row small-collapse large-collapse">
			<div class="small-6 large-6 columns">
				<a class="<?php if($_GET['action'] == 'companyInfo') { echo 'active-om'; } ?>" href="<?php SITE_URL; ?>order.php?action=companyInfo" class="text-center">Компаний бүртгэл</a>
			</div>
			<div class="small-6 large-6 columns">
				<a class="<?php if($_GET['action'] == 'loginOrder') { echo 'active-om'; } ?>" href="#" class="text-center">Шууд захиалга</a>
			</div>
		</div>
		</div>
	</div>
	...
	<form action="order.php?action=loginOrder" method="post" autocomplete="off">
        ...
        <div class="small-10 large-6 small-centered large-centered columns">
        	<div class="row small-collapse large-collapse">
        		...
        		<div class="small-5 large-5 columns text-center">
        			<a href="order.php?action=loginOrder" class="button small expand red">Цуцлах</a>
        		</div>
        	</div>
        </div>
	</form>
