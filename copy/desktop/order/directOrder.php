						...
						<div class="row">
							...
							<div class="medium-6 columns">
								<div class="orderFormRow" style="border-top: none;">
        							...
        							<input name="company_name" type="text" id="CompanyName" required="required"/>
								</div>
								<div class="orderFormRow">
									<label>Захиалагчийн нэр</label>
        							<input name="client_name" type="text" id="ClinetName" required="required"/>
								</div>
								<div class="orderFormRow">
						...
						<div class="row">
							<div class="medium-9 medium-centered columns">
								<div class="orderFormBtn">
        							...
        							<a class="cancelOrder" href="order.php?action=directOrder">Цуцлах</a>	
        						</div>	
							</div>
						</div>
					</form>
