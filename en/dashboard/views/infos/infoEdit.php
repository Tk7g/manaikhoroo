		...
		<div class="box-content">
			...
			<fieldset>
				...
				<div class="control-group">
					...
					<div class="controls">
						<select name="year" id="Year" required="required">
							...
							<option <?php if($info['year'] == $yr['year']) { echo 'selected'; } ?> value="<?php echo $yr['year']; ?>"><?php echo $yr['year'] ?></option>
							<?php endforeach; ?>
						</select>
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="area_length" value="<?php echo $info['area_length']; ?>" required="required" class="input-xlarge"/>
					</div>
				</div>
				<div class="control-group">
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="toron_garts" value="<?php echo $info['toron_garts']; ?>" required="required" class="input-xlarge"/>
					</div>
				</div>
				<div class="control-group">
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="risk_area" value="<?php echo $info['risk_area']; ?>" required="required" class="input-xlarge"/>
					</div>
				</div>
				<!--<div class="control-group">
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="pale_ground" required="required" value="<?php echo $info['pale_ground']; ?>" class="input-xlarge"/>
					</div>
				</div>
				<div class="control-group">
