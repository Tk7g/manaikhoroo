...
<ul class="breadcrumb">
	...
	<li>
		<a href="/dashboard/road.php">Замын зураглал</a>
	</li>
</ul>
...
<div class="row-fluid sortable">
	<div class="box span11">
		<div class="box-header" data-original-title>
			<h2><i class="halflings-icon pencil"></i><span class="break"></span>Замын зураглал нэмэх</h2>
			<div class="box-icon">
				<a href="#" class="btn-minimize"><i class="halflings-icon chevron-up"></i></a>
			</div>
		</div>
		<div class="box-content">
			<form action="road.php?action=add" id="" method="post">
			<fieldset>
				<div class="control-group">
					<label class="control-label" for="MarkerType">Замын харьяалагдах дүүрэг</label>
					<div class="controls">
