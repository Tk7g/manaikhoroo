...
<div class="row-fluid sortable">
	<div class="box span11">
		...
		<div class="box-content">
			<form action="markers.php?action=civDistrictMarkerAccept&marker=<?php echo $marker['id']; ?>" id="saveDistrictMarker" method="post">
			<fieldset>
				...
				<button style="margin-bottom: 10px;" type="submit" name="acceptMarker" class="btn btn-primary">Зөвшөөрөх</button>
				<div id="msg-block">
				</div>
				<div id="map-box">
...
function initialize() {
	...
	districtMarkers(<?php echo $marker['type_id']; ?>, <?php echo $marker['region_id'] ?>)
}

function districtMarkers(typeid, region) {
	$.getJSON('<?php echo MAIN_URL; ?>markers.php?action=civRegionMarkers&type='+typeid+'&region='+region+'&region_accept=1', function(point){
