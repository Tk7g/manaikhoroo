	...
	<div class="box span11">
		...
		<div class="box-content">
			...
			<fieldset>
				...
				<label class="control-label" for="Coordinate">Торон гарцын тайлбар (гарчиг, нэр)</label>
			...
			<div id="btn-panel">
				...
				<input id="showData" value="Торон гарцын координатууд гаргах" type="button" class="navi"/>
			</div>
