...
<ul class="breadcrumb">
	...
	<li>
		<a href="/dashboard/playground.php">Ногоон байгууламж болох боломжит газар</a>
	</li>
</ul>
...
<div class="row-fluid sortable">
	<div class="box span11">
		<div class="box-header" data-original-title>
			<h2><i class="halflings-icon pencil"></i><span class="break"></span><?php echo $district['title'].' дүүргийн '.$region['title'].'-р хорооны '; ?>ногоон байгууламж нэмэх</h2>
			<div class="box-icon">
		...
		<div class="box-content">
			...
			<fieldset>
				...
				<label class="control-label" for="Coordinate">Ногоон байгууламжийн гарчиг (тайлбар)</label>
			...
			<div id="btn-panel">
				<input id="reset" value="Хэсгийн хил устгах" type="button" class="navi"/>
				<input id="showData" value="Хэсгийн хилийн координатууд гаргах" type="button" class="navi"/>
			</div>
