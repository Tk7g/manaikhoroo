			...
			<div class="page-report">
				...
				<div class="reportMapLarge">
					...
					<div class="reportMapTitle">
						...
						<?php echo 'Kindergarten of '.$district['title'].' district'; ?>
						</div>
					</div>
				...
				<div class="reportBottom">
					...
					<div class="reportGraph">
						<div class="reportGraphTitle"><?php echo 'Kindergarten comparison of capital city of '.$_GET['year']; ?></div>
						<div>
...
function initialize() {
	...
	<?php foreach($regions as $sec) : ?>
		addRegion(<?php echo $sec['id']; ?>, '<?php echo $kin_color[$sec['id']]; ?>', mapLarge);
	<?php endforeach; ?>
	
	addRegionDistrict(<?php echo $district['id']; ?>, mapLarge);
	//districtBorder(<?php echo $_GET['district']; ?>, mapLarge);
	
	addWalk(<?php echo $district['id']; ?>, "#195734", 100, 0.5, 3, mapLarge);
	addWalk(<?php echo $district['id']; ?>, "#8ba686", 200, 0.4, 3, mapLarge);
	addWalk(<?php echo $district['id']; ?>, "#cfd4c1", 300, 0.3, 3, mapLarge);
	addWalk(<?php echo $district['id']; ?>, "#f0e5d8", 400, 0.2, 3, mapLarge);
	addMarker(<?php echo $district['id']; ?>, 3, '<?php echo MAIN_FOLDER."/images/reportProfile/kindergarden.jpg"; ?>', mapLarge, iconBus);
