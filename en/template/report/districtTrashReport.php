			...
			<div class="page-report">
				...
				<div class="reportMapLarge">
					...
					<div class="reportMapTitle">
						...
						<?php echo 'Trash report of '.$district['title'].' district'; ?>
						</div>
					</div>
				...
				<div class="reportBottom">
					...
					<div class="reportGraph">
						<div class="reportGraphTitle"><?php echo 'Illegal trash dump sites comparison of capital city of '.$_GET['year']; ?></div>
						<div>
