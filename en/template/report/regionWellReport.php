			...
			<div class="page-report">
				...
				<div class="reportMapLarge">
					...
					<div class="reportMapTitle">
						...
						<?php echo 'Water kiosks of region '.$region['title'].' of '.$district['title'].' district'; ?>
						</div>
					</div>
				...
				<div class="reportBottom">
					...
					<div class="reportGraph">
						<div class="reportGraphTitle"><?php echo 'Water kiosk comparison of '.$district['title'].' district of '.$_GET['year']; ?></div>
						<div>
					...
					<div class="reportBottomInfo">
						...
						<div class="reportBottomTitle">
							Хүн амын <?php echo number_format($info['well_density']); ?>% of total population lives within 5 minutes walk from water kiosk.
						</div>
						<div class="reportBottomCount">
							<?php echo number_format($count_marker['COUNT(*)']/$info['population']*1000, 1); ?>
						</div>
						<div class="reportBottomTitle">
							<?php echo number_format($count_marker['COUNT(*)']/$info['population']*1000, 1); ?> water kiosk per 1000 people
						</div>
					</div>
				</div>
			</div>
...
<?php }} ?>
	...
	addMarker(<?php echo $region['id']; ?>, 2, '<?php echo MAIN_FOLDER."/images/reportProfile/well.png"; ?>', mapLarge, iconBus);
