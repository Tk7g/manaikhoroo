			...
			<div class="page-report">
				...
				<div class="reportMapLarge">
					...
					<div class="reportMapTitle">
						...
						<?php echo 'School of region '.$region['title'].' of '.$district['title'].' district'; ?>
						</div>
					</div>
					...
					<div class="reportBottomInfo">
						<table width="100%">
							<tr>
								...
								<th width="30%">Total children between 6-16 ages</th>
								<th width="30%">Total children between 6-16 ages absent from school</th>
								<th width="30%">% of children between 6-16 ages absent from school</th>
							</tr>
<?php
	$rowCheck = NULL;
...
<?php } ?>
	...
	addMarker(<?php echo $region['id']; ?>, 4, '<?php echo MAIN_FOLDER."/images/reportProfile/school.jpg"; ?>', mapLarge, iconBus);
