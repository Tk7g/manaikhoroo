	...
	<div class="container">
		<div class="row">
			...
			<div class="page-report">
				...
				<a class="reportBtn" href="http://FreeHTMLtoPDF.com/?convert=http%3A%2F%2Fmanaikhoroo.ub.gov.mn%2Freport.php%3Faction%3DregionBusReportPdf%26district=<?php echo $_GET['district']; ?>%26region=<?php echo $_GET['region']; ?>%26year=<?php echo $_GET['year']; ?>&size=A4&orientation=portrait&enablejs=1">
				...
				<div class="reportMapLarge">
					...
					<div class="reportMapTitle">
						...
						<?php echo "Public transport of region ".$region['title']." of ".$district['title']." district"; ?>
						</div>
					</div>
				...
				<div class="reportBottom">
					...
					<div class="reportGraph">
						<div class="reportGraphTitle"><?php echo 'Bus stop comparison of '.$district['title'].' district of '.$_GET['year']; ?></div>
						<div>
					...
					<div class="reportBottomInfo">
						<div class="reportBottomTitle">
							<?php echo 'Total bus stop of '.$_GET['year'];  ?>
						</div>
...
mapLarge.set('styles', [
  {
	...
	addMarker(<?php echo $region['id']; ?>, 1, '<?php echo MAIN_FOLDER."/images/reportProfile/bus.jpg"; ?>', mapLarge, iconBus);
	addMarker(<?php echo $region['id']; ?>, 7, '<?php echo MAIN_FOLDER."/images/reportProfile/light.png"; ?>', mapLarge, iconLight);
	<?php foreach($regions as $reg) : ?>
