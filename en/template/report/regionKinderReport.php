	...
	<div class="container">
		<div class="row">
			...
			<div class="page-report">
				...
				<a class="reportBtn" href="http://FreeHTMLtoPDF.com/?convert=http%3A%2F%2Fmanaikhoroo.ub.gov.mn%2Freport.php%3Faction%3DregionKinderReportPdf%26district=<?php echo $_GET['district']; ?>%26region=<?php echo $_GET['region']; ?>%26year=<?php echo $_GET['year']; ?>&size=A4&orientation=portrait&enablejs=1">
				...
				<div class="reportMapLarge">
					...
					<div class="reportMapTitle">
						...
						<?php echo 'Kindergarten of region '.$region['title'].' of '.$district['title'].' district'; ?>
						</div>
					</div>
						...
						<div class="reportDetailInfo">
							...
							<div class="reportDetailRow">
								<div class="reportDetailSub">
									Children absent from kindergarten
								</div>
							</div>
							<div class="reportDetailRow">
								<div class="reportDetailImage">
					...
					<div class="reportBottomInfo">
						<table width="100%">
							<tr>
								...
								<th width="30%">Total children between 2-5 ages</th>
								<th width="30%">Total children between 2-5 ages absent from kindergarten</th>
								<th width="30%">% of children between 2-5 ages absent from kindergarten</th>
							</tr>
<?php
	$rowCheck = NULL;
...
?>
					...
					<div class="reportBottomInfo">
						<div class="reportBottomTitle">
							<?php echo 'Total kindergarten of '.$_GET['year'];  ?>
						</div>
...
<?php }} ?>
	...
	setTimeout(function () {
    	addWalk(<?php echo $region['id']; ?>, "#cdd3c0", 300, 0.4, 3, mapLarge);    
    }, 1500);
	setTimeout(function () {
    	addWalk(<?php echo $region['id']; ?>, "#8ba686", 200, 0.5, 3, mapLarge);    
    }, 2000);
    setTimeout(function () {
    	addWalk(<?php echo $region['id']; ?>, "#195734", 100, 0.6, 3, mapLarge);    
    }, 3000);
    
    google.maps.event.addListener(mapLarge, 'zoom_changed', function() {
		
    	removeMarker(<?php echo $region['id']; ?>, 3, iconBus);
    	addMarker(<?php echo $region['id']; ?>, 3, '<?php echo MAIN_FOLDER."/images/reportProfile/kindergarden.jpg"; ?>', mapLarge, iconBus);
