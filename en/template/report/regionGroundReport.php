			...
			<div class="page-report">
				...
				<div class="reportMapLarge">
					...
					<div class="reportMapTitle">
						...
						<?php echo 'Public space of region '.$region['title'].' of '.$district['title'].' district'; ?>
						</div>
					</div>
				...
				<div class="reportBottom">
					...
					<div class="reportGraph">
						<div class="reportGraphTitle"><?php echo 'Playground comparison of '.$district['title'].' district of '.$_GET['year']; ?></div>
						<div>
					...
					<div class="reportBottomInfo">
						<div class="reportBottomTitle">
							<?php echo 'Total playgrounds of '.$_GET['year'];  ?>
						</div>
...
mapLarge.set('styles', [
  {
	...
	addMarker(<?php echo $region['id']; ?>, 20, '<?php echo MAIN_FOLDER."/images/reportProfile/parking.png"; ?>', mapLarge, iconParking);
	addMarker(<?php echo $region['id']; ?>, 19, '<?php echo MAIN_FOLDER."/images/reportProfile/playground.png"; ?>', mapLarge, iconPlayground);
...
var barChartData = {
	labels : [<?php foreach($regions as $reg) { echo '"region '.$reg['title'].'",'; } ?>],
	datasets : [
		{
