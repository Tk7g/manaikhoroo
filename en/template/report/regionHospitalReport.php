...
<div id="reportPage">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
			<img src="<?php echo MAIN_FOLDER.'/images/reportProfile/bg-red.jpg'; ?>" class="bg-page-image"/>
			<div class="page-report">
				...
				<a class="reportBtn" href="http://FreeHTMLtoPDF.com/?convert=http%3A%2F%2Fmanaikhoroo.ub.gov.mn%2Freport.php%3Faction%3DregionHospitalReportPdf%26district=<?php echo $_GET['district']; ?>%26region=<?php echo $_GET['region']; ?>%26year=<?php echo $_GET['year']; ?>&size=A4&orientation=portrait&enablejs=1">
				...
				<div class="reportMapLarge">
					...
					<div class="reportMapTitle">
						...
						<?php echo 'Healthcare of region '.$region['title'].' of '.$district['title'].' district'; ?>
						</div>
					</div>
						...
						<div class="reportDetailInfo">
							...
							<div class="reportDetailRow">
								<div class="reportDetailImage">
									<img src="<?php echo MAIN_FOLDER."/images/reportProfile/hos.png"; ?>" />
								</div>
				...
				<div class="reportBottom">
					<img src="<?php echo MAIN_FOLDER.'/images/reportProfile/hos-bottom.jpg'; ?>" class="reportBottomImg" />
					<div class="reportGraph">
						<div class="reportGraphTitle"><?php echo 'Comparison of healthcare center of '.$district['title'].' district of '.$_GET['year']; ?></div>
						<div>
					...
					<div class="reportBottomInfo">
						<div class="reportBottomTitle">
							<?php echo 'Total healthcare center of '.$_GET['year'];  ?>
						</div>
...
mapLarge.set('styles', [
  {
	...
	addMarker(<?php echo $region['id']; ?>, 9, '<?php echo MAIN_FOLDER."/images/reportProfile/hos.png"; ?>', mapLarge, iconBus);
...
<?php }} ?>
	...
	setTimeout(function () {
    	addWalk(<?php echo $region['id']; ?>, "#f0e5d8", 400, 0.25, 9, mapLarge);   
    }, 1000);
	setTimeout(function () {
    	addWalk(<?php echo $region['id']; ?>, "#cdd3c0", 300, 0.4, 9, mapLarge);    
    }, 1500);
	setTimeout(function () {
    	addWalk(<?php echo $region['id']; ?>, "#8ba686", 200, 0.5, 9, mapLarge);    
    }, 2000);
    setTimeout(function () {
    	addWalk(<?php echo $region['id']; ?>, "#195734", 100, 0.6, 9, mapLarge);    
    }, 3000);
    
     google.maps.event.addListener(mapLarge, 'zoom_changed', function() {
		
    	removeMarker(<?php echo $region['id']; ?>, 9, iconBus);
    	addMarker(<?php echo $region['id']; ?>, 9, '<?php echo MAIN_FOLDER."/images/reportProfile/hos.png"; ?>', mapLarge, iconBus);
