			...
			<div class="page-report">
				...
				<div class="reportMapLarge">
					...
					<div class="reportMapTitle">
						...
						<?php echo 'Healthcare of '.$district['title'].' district'; ?>
						</div>
					</div>
				...
				<div class="reportBottom">
					...
					<div class="reportGraph">
						<div class="reportGraphTitle"><?php echo 'Healthcare center comparison of capital city of '.$_GET['year']; ?></div>
						<div>
...
function initialize() {
	...
	<?php foreach($regions as $sec) : ?>
		addRegion(<?php echo $sec['id']; ?>, '<?php echo $pop_color[$sec['id']]; ?>', mapLarge);
	<?php endforeach; ?>
	...
	addWalk(<?php echo $district['id']; ?>, "#195734", 100, 0.5, 9, mapLarge);
	addWalk(<?php echo $district['id']; ?>, "#8ba686", 200, 0.4, 9, mapLarge);
	addWalk(<?php echo $district['id']; ?>, "#cfd4c1", 300, 0.3, 9, mapLarge);
	addWalk(<?php echo $district['id']; ?>, "#f0e5d8", 400, 0.2, 9, mapLarge);
	addMarker(<?php echo $district['id']; ?>, 9, '<?php echo MAIN_FOLDER."/images/reportProfile/hos.png"; ?>', mapLarge, iconBus);
