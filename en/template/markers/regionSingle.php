...
function initialize() {
	var mapOptions = {
		zoom: <?php echo $current_region['zoom']; ?>,
		center: new google.maps.LatLng(<?php echo $current_region['center'] ?>),
		panControl: false,
		maxZoom: 19,
		minZoom: 9,
...
var styles1 = [
  {
	...
	$("#hybridSelect").click(function(){
		map.setOptions({mapTypeId: google.maps.MapTypeId.HYBRID, styles: styles1});
	});
...
<div class="infopage-title">
	<?php echo 'Data of '.$results['district']['title'].' district'; ?>
</div>
<div id="mapbox-info">
	<div class="container">
		<div class="row">
...
<div class="col-label">
	...
	<div class="row-rgtable row-label">
		Percent of people living 5 min walk from water kiosk
	</div>
	<div class="row-rgtable row-label">
		Ratio water kiosks : 1000 people
	</div>
	<div class="row-rgtable row-label">
		Illegal trash dump sites
	</div>
	<div class="row-rgtable row-label">
		Percent of people living 100m near area of risk 
	</div>
	<div class="row-rgtable row-label">
		Number of health clinics
	</div>
	<div class="row-rgtable row-label">
		Ratio healtch clinics : 100 people
	</div>
	<div class="row-rgtable row-label">
...
<div class="col-city">
	...
	<div class="row-rgtable row-value">
		<?php echo $results['city']['well_num']; ?>
	</div>
	<div class="row-rgtable row-value">
	...
	<div class="row-rgtable row-value">
		<?php echo $results['city']['trash_num']; ?>
	</div>
	<div class="row-rgtable row-value">
		<?php echo round($results['city']['risk_ratio'], 2); ?>
	</div>
	<div class="row-rgtable row-value">
		<?php echo $results['city']['hospital_num']; ?>
	</div>
	<div class="row-rgtable row-value">
...
<div class="col-district">
	...
	<div class="row-rgtable row-value">
		<?php 
		if($results['district_info'] != NULL) {
			echo $results['district_info']['well_num']; 
		}
		?>
	</div>
	<div class="row-rgtable row-value">
	...
	<div class="row-rgtable row-value">
		<?php 
			if($results['district_info'] != NULL) {
				echo $results['district_info']['trash_num']; 
			}
		?>
	</div>
	<div class="row-rgtable row-value">
	...
	<div class="row-rgtable row-value">
		<?php 
		if($results['district_info'] != NULL) {
			echo $results['district_info']['hospital_num']; 
		}
		?>
	</div>
	<div class="row-rgtable row-value">
