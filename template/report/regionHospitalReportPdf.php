...
mapLarge.set('styles', [
  {
	...
	addWalk(<?php echo $region['id']; ?>, "#cfd4c1", 300, 0.3, 9, mapLarge);
	addWalk(<?php echo $region['id']; ?>, "#8ba686", 200, 0.4, 9, mapLarge);
	addWalk(<?php echo $region['id']; ?>, "#195734", 100, 0.3, 9, mapLarge);
	...
	$.getJSON('<?php echo SITE_URL; ?>report.php?action=getRegionMarkers&type='+type+'&region='+region, function(point){
		if(point.coordinate.length == 0) {
			...
			var iconImg = {
				...
				scaledSize: new google.maps.Size(12, 13)
			}
