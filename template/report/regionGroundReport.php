...
<div id="reportPage">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
			<img src="<?php echo MAIN_FOLDER.'/images/reportProfile/bg-blue.jpg'; ?>" class="bg-page-image"/>
			<div class="page-report">
				...
				<a class="reportBtn" href="http://FreeHTMLtoPDF.com/?convert=http%3A%2F%2Fmanaikhoroo.ub.gov.mn%2Freport.php%3Faction%3DregionGroundReportPdf%26district=<?php echo $_GET['district']; ?>%26region=<?php echo $_GET['region']; ?>%26year=<?php echo $_GET['year']; ?>&size=A4&orientation=portrait&enablejs=1">
					...
					<div class="profileCol2">
						<div class="profileTopInfo">
							...
							<div class="profileTopCol">
								...
								<div class="profileTopDetail">
									<div class="profileTopNumber">
										<?php echo number_format($info['population_density']); ?>
									</div>
									<div class="profileTopSub">
				...
				<div class="reportMapLarge">
					...
					<div class="reportMapTitle">
						...
						<?php echo $district['title'].' дүүргийн '.$region['title'].'-р хорооны нийтийн эзэмшлийн талбай'; ?>
						</div>
					</div>
						...
						<div class="reportDetailInfo">
							...
							<div class="reportDetailRow">
								<div class="reportDetailImage">
									<img src="<?php echo MAIN_FOLDER."/images/reportProfile/playground.png"; ?>" />
								</div>
							...
							<div class="reportDetailRow">
								<div class="reportDetailImage">
									<img src="<?php echo MAIN_FOLDER."/images/reportProfile/parking.png"; ?>" />
								</div>
								<div class="reportDetailDesc">
									Авто машины зогсоол
								</div>
							...
							<div class="reportDetailRow">
								<div class="reportDetailImage">
									<img src="<?php echo MAIN_FOLDER."/images/reportProfile/garden.png"; ?>" />
								</div>
								<div class="reportDetailDesc">
				...
				<div class="reportBottom">
					<img src="<?php echo MAIN_FOLDER.'/images/reportProfile/ground-bottom.jpg'; ?>" class="reportBottomImg" />
					<div class="reportGraph">
						<div class="reportGraphTitle"><?php echo $district['title'].' дүүргийн хороодуудын '.$_GET['year'].' оны тоглоомын талбайн харьцуулалт'; ?></div>
						<div>
					...
					<div class="reportBottomInfo">
						<div class="reportBottomTitle">
							<?php echo $_GET['year'].' оны тоглоомын талбайн тоо';  ?>
						</div>
...
<script>
	...
	<?php foreach($gardens as $gd) : ?>
		var gardenCoord<?php echo $gd['id']; ?> = [];
	<?php endforeach; ?>
...
<?php } ?>
	...
	<?php endforeach; ?>
	<?php foreach($gardens as $gd) : ?>
		addGarden(<?php echo $gd['id']; ?>, mapLarge);
	<?php endforeach; ?>
	regionBorder(<?php echo $_GET['district']; ?>, <?php echo $_GET['region']; ?>, mapLarge);
	addMarker(<?php echo $region['id']; ?>, 20, '<?php echo MAIN_FOLDER."/images/reportProfile/parking.png"; ?>', mapLarge, iconParking, <?php echo $_GET['year']; ?>);
	addMarker(<?php echo $region['id']; ?>, 19, '<?php echo MAIN_FOLDER."/images/reportProfile/playground.png"; ?>', mapLarge, iconPlayground, <?php echo $_GET['year']; ?>);
...
<?php }} ?>
	...
	google.maps.event.addListener(mapLarge, 'zoom_changed', function() {
    	...
    	removeMarker(<?php echo $region['id']; ?>, 20, iconParking);
    	removeMarker(<?php echo $region['id']; ?>, 19, iconPlayground);
    	addMarker(<?php echo $region['id']; ?>, 20, '<?php echo MAIN_FOLDER."/images/reportProfile/parking.png"; ?>', mapLarge, iconParking, <?php echo $_GET['year']; ?>);
    	addMarker(<?php echo $region['id']; ?>, 19, '<?php echo MAIN_FOLDER."/images/reportProfile/playground.png"; ?>', mapLarge, iconPlayground, <?php echo $_GET['year']; ?>);
...
function addGarden(section, mapVar) {
	$.getJSON('<?php echo SITE_URL; ?>marker.php?page=playgroundBorder&playground='+section, function(point){
		if(point.coordinate.length == 0) {
			return;
		} else {
			window['gardenCoord'+section] = [];
			for(var k = 0; k < point.coordinate.length; k++) {
				window['gardenCoord'+section][k] = new google.maps.LatLng(point.coordinate[k][0], point.coordinate[k][1]);
			}
			window['gardenArea'+section] = new google.maps.Polygon({
    			path: window['gardenCoord'+section],
    			 strokeColor: '#2b690d',
    			 strokeOpacity: 1,
    			 strokeWeight: 1,
    			 fillColor: '#40c600',
			...
			window['gardenArea'+section].setMap(mapVar);
		}
	});
}
