			...
			<div class="page-report">
				...
				<div class="reportMapLarge">
					...
					<div class="reportMapTitle">
						...
						<?php echo $district['title'].' дүүргийн '.$region['title'].'-р хорооны эрүүл мэнд'; ?>
						</div>
					</div>
				...
				<div class="reportBottom">
					...
					<div class="reportGraph">
						<div class="reportGraphTitle"><?php echo $district['title'].' дүүргийн хороодуудын '.$_GET['year'].' оны эмнэлгийн харьцуулалт'; ?></div>
						<div>
					...
					<div class="reportBottomInfo">
						<div class="reportBottomTitle">
							<?php echo $_GET['year'].' оны эмнэлгийн тоо';  ?>
						</div>
...
<?php } ?>
	...
	addMarker(<?php echo $region['id']; ?>, 9, '<?php echo MAIN_FOLDER."/images/reportProfile/hos.png"; ?>', mapLarge, iconBus, <?php echo $_GET['year']; ?>);
