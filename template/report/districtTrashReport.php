			...
			<div class="page-report">
				...
				<div class="reportMapLarge">
					...
					<div class="reportMapTitle">
						...
						<?php echo $district['title'].' дүүргийн хог хаягдал'; ?>
						</div>
					</div>
					<div class="reportDetailBox">
						...
						<div class="reportDetailInfo">
							...
							<div class="reportDetailRow">
								<div class="reportDetailImage">
									<img src="<?php echo MAIN_FOLDER."/images/reportProfile/400.jpg"; ?>" />
								</div>
								<div class="reportDetailDesc">
									400м
								</div>
							...
							<div class="reportDetailRow">
								<div class="reportDetailImage">
									<img src="<?php echo MAIN_FOLDER."/images/reportProfile/300.jpg"; ?>" />
								</div>
								<div class="reportDetailDesc">
									300м
								</div>
							...
							<div class="reportDetailRow">
								<div class="reportDetailImage">
									<img src="<?php echo MAIN_FOLDER."/images/reportProfile/200.jpg"; ?>" />
								</div>
								<div class="reportDetailDesc">
									200м
								</div>
							...
							<div class="reportDetailRow">
								<div class="reportDetailImage">
									<img src="<?php echo MAIN_FOLDER."/images/reportProfile/100.jpg"; ?>" />
								</div>
								<div class="reportDetailDesc">
									100м
								</div>
				...
				<div class="reportBottom">
					...
					<div class="reportGraph">
						<div class="reportGraphTitle"><?php echo 'Нийслэлийн дүүргүүдийн '.$_GET['year'].' оны албан бус хогийн цэгийн харьцуулалт'; ?></div>
						<div>
...
function initialize() {
	...
	addMarker(<?php echo $district['id']; ?>, 10, '<?php echo MAIN_FOLDER."/images/reportProfile/trash.png"; ?>', mapLarge, iconBus);
