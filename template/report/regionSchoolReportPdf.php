...
<?php } ?>
	...
	addWalk(<?php echo $region['id']; ?>, "#cfd4c1", 300, 0.3, 4, mapLarge);
	addWalk(<?php echo $region['id']; ?>, "#8ba686", 200, 0.4, 4, mapLarge);
	addWalk(<?php echo $region['id']; ?>, "#195734", 100, 0.3, 4, mapLarge);
	<?php foreach($regions as $reg) : ?>
