...
<div class="report-row">
	<div class="report-col">
		<a href="http://manaikhoroo.ub.gov.mn/report.php?action=districtProfileReport&district=<?php echo $_GET['district']; ?>&year=<?php echo $_GET['year']; ?>"><?php echo $district_title['title'].' дүүргийн '.$_GET['year'].' оны нэгтгэсэн зураглал'; ?></a>
	</div>
	<div class="report-col">
		<a href="http://manaikhoroo.ub.gov.mn/report.php?action=districtBusReport&district=<?php echo $_GET['district']; ?>&year=<?php echo $_GET['year']; ?>"><?php echo $district_title['title'].' дүүргийн '.$_GET['year'].' оны нийтийн тээвэр'; ?></a>
	</div>
	<div class="report-col">
		<a href="http://manaikhoroo.ub.gov.mn/report.php?action=districtSchoolReport&district=<?php echo $_GET['district']; ?>&year=<?php echo $_GET['year']; ?>"><?php echo $district_title['title'].' дүүргийн '.$_GET['year'].' оны сургууль'; ?></a>
	</div>
	<div class="report-col">
		<a href="http://manaikhoroo.ub.gov.mn/report.php?action=districtKinderReport&district=<?php echo $_GET['district']; ?>&year=<?php echo $_GET['year']; ?>"><?php echo $district_title['title'].' дүүргийн '.$_GET['year'].' оны цэцэрлэг'; ?></a>
	</div>
	<div class="report-col">
		<a href="http://manaikhoroo.ub.gov.mn/report.php?action=districtHospitalReport&district=<?php echo $_GET['district']; ?>&year=<?php echo $_GET['year']; ?>"><?php echo $district_title['title'].' дүүргийн '.$_GET['year'].' оны эрүүл мэнд'; ?></a>
	</div>
	<div class="report-col">
		<a href="http://manaikhoroo.ub.gov.mn/report.php?action=districtTrashReport&district=<?php echo $_GET['district']; ?>&year=<?php echo $_GET['year']; ?>"><?php echo $district_title['title'].' дүүргийн '.$_GET['year'].' оны хог хаягдал'; ?></a>
	</div>
</div>
