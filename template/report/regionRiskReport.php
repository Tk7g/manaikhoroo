...
<div id="reportPage">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
			<img src="<?php echo MAIN_FOLDER.'/images/reportProfile/bg-orange2.jpg'; ?>" class="bg-page-image"/>
			<div class="page-report">
				...
				<div class="reportMapLarge">
					...
					<div class="reportMapTitle">
						...
						<?php echo $district['title'].' дүүргийн '.$region['title'].'-р хорооны аюултай бүс'; ?>
						</div>
					</div>
						...
						<div class="reportDetailInfo">
							...
							<div class="reportDetailRow">
								<div class="reportDetailImage">
									<img src="<?php echo MAIN_FOLDER."/images/reportProfile/flood.png"; ?>" />
								</div>
							...
							<div class="reportDetailRow">
								<div class="reportDetailImage">
									<img src="<?php echo MAIN_FOLDER."/images/reportProfile/police.png"; ?>" />
								</div>
								<div class="reportDetailDesc">
									Цагдаагийн хэсэг
								</div>
							...
							<div class="reportDetailRow">
								<div class="reportDetailImage">
									<img src="<?php echo MAIN_FOLDER."/images/reportProfile/crime.png"; ?>" />
								</div>
								<div class="reportDetailDesc">
									Гэмт хэрэг гарч болзошгүй хэсэг
								</div>
							</div>
							<div class="reportDetailRow">
								<div class="reportDetailImage">
									<img src="<?php echo MAIN_FOLDER."/images/reportProfile/fuel.png"; ?>" />
								</div>
								<div class="reportDetailDesc">
				...
				<div class="reportBottom">
					<img src="<?php echo MAIN_FOLDER.'/images/reportProfile/risk-bottom.jpg'; ?>" class="reportBottomImg" />
					<div class="reportGraph">
						<div class="reportGraphTitle"><?php echo $district['title'].' дүүргийн хороодуудын '.$_GET['year'].' оны гэмт хэрэг гарч болзошгүй хэсгийн харьцуулалт'; ?></div>
						<div>
					...
					<div class="reportBottomInfo">
						<div class="reportBottomTitle">
							<?php echo $_GET['year'].' оны гэмт хэрэг гарч болзошгүй хэсгийн тоо';  ?>
						</div>
						<div class="reportBottomCount">
							<?php echo $crime_count['COUNT(*)']; ?>
						</div>
						<div class="reportBottomTitle">
							<?php echo $_GET['year'].' оны цагдаагийн хэсгийн тоо';  ?>
						</div>
						<div class="reportBottomCount">
							<?php echo $police_count['COUNT(*)']; ?>
						</div>
					</div>
				</div>
			</div>
...
<?php } ?>
	...
	<?php foreach($sections as $sec) : ?>
		...
		?>
	<?php endforeach; ?>
	<?php foreach($risks as $gd) : ?>
		addRisk(<?php echo $gd['id']; ?>, mapLarge);
	<?php endforeach; ?>
	regionBorder(<?php echo $_GET['district']; ?>, <?php echo $_GET['region']; ?>, mapLarge);
	addMarker(<?php echo $region['id']; ?>, 6, '<?php echo MAIN_FOLDER."/images/reportProfile/crime.png"; ?>', mapLarge, iconBus, <?php echo $_GET['year']; ?>);
	addMarker(<?php echo $region['id']; ?>, 15, '<?php echo MAIN_FOLDER."/images/reportProfile/fuel.png"; ?>', mapLarge, iconFuel, <?php echo $_GET['year']; ?>);
	addMarker(<?php echo $region['id']; ?>, 5, '<?php echo MAIN_FOLDER."/images/reportProfile/police.png"; ?>', mapLarge, iconLight, <?php echo $_GET['year']; ?>);
...
<?php }} ?>
	...
	google.maps.event.addListener(mapLarge, 'zoom_changed', function() {
    	...
    	removeMarker(<?php echo $region['id']; ?>, 6, iconBus);
    	removeMarker(<?php echo $region['id']; ?>, 15, iconFuel);
    	removeMarker(<?php echo $region['id']; ?>, 5, iconLight);
    	addMarker(<?php echo $region['id']; ?>, 6, '<?php echo MAIN_FOLDER."/images/reportProfile/crime.png"; ?>', mapLarge, iconBus, <?php echo $_GET['year']; ?>);
    	addMarker(<?php echo $region['id']; ?>, 15, '<?php echo MAIN_FOLDER."/images/reportProfile/fuel.png"; ?>', mapLarge, iconFuel, <?php echo $_GET['year']; ?>);
    	addMarker(<?php echo $region['id']; ?>, 5, '<?php echo MAIN_FOLDER."/images/reportProfile/police.png"; ?>', mapLarge, iconLight, <?php echo $_GET['year']; ?>);
...
function addRisk(section, mapVar) {
	$.getJSON('<?php echo SITE_URL; ?>marker.php?page=risksBorder&risks='+section, function(point){
		if(point.coordinate.length == 0) {
			return;
		} else {
			window['riskCoord'+section] = [];
			for(var k = 0; k < point.coordinate.length; k++) {
				window['riskCoord'+section][k] = new google.maps.LatLng(point.coordinate[k][0], point.coordinate[k][1]);
			}
			window['riskArea'+section] = new google.maps.Polygon({
    			path: window['riskCoord'+section],
    			 strokeColor: '#c90076',
    			 strokeOpacity: 1,
    			 strokeWeight: 1,
    			 fillColor: '#ff68c1',
			...
			window['riskArea'+section].setMap(mapVar);
		}
	});
}
