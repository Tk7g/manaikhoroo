	...
	<div class="box span11">
		...
		<div class="box-content">
			<video width="300" height="147" controls>
  				<source src="<?php echo MAIN_FOLDER.'/video/khoroo/toonmedeelel.mp4'; ?>" type="video/mp4">
  				<source src="<?php echo MAIN_FOLDER.'/video/khoroo/toonmedeelel.ogg'; ?>" type="video/ogg">
