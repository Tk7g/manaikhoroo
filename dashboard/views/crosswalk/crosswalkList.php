...
<ul class="breadcrumb">
	...
	<li>
		<a href="/dashboard/risks.php">Авто замын гарц гаргах боломжит газар /<?php echo $districtHeader['title'].' дүүргийн '.$regionHeader['title'].'-р хороо'; ?>/</a>
	</li>
</ul>
...
<div class="row-fluid sortable">
	<div class="box span11">
		<div class="box-header" data-original-title>
			<h2><i class="halflings-icon pencil"></i><span class="break"></span>Авто замын гарц гаргах боломжит газар /<?php echo $districtHeader['title'].' дүүргийн '.$regionHeader['title'].'-р хороо'; ?>/</h2>
			<div class="box-icon">
		...
		<div class="box-content">
			<video width="300" height="147" controls>
  				<source src="<?php echo MAIN_FOLDER.'/video/khoroo/ayultai_bus.mp4'; ?>" type="video/mp4">
  				<source src="<?php echo MAIN_FOLDER.'/video/khoroo/ayultai_bus.ogg'; ?>" type="video/ogg">
