...
<ul class="breadcrumb">
	...
	<li>
		<a href="/dashboard/risks.php">Авто замын гарц гаргах боломжит газар /<?php echo $district['title'].' дүүргийн '.$region['title'].'-р хороо'; ?>/</a>
	</li>
</ul>
...
<div class="row-fluid">
	<div class="box2 span12">
		<div class="box-header" data-original-title>
			<h2><i class="halflings-icon pencil"></i><span class="break"></span><?php echo $district['title'].' дүүргийн '.$region['title'].'-р хорооны '; ?> авто замын гарц гаргах боломжит газар нэмэх</h2>
			<div class="box-icon">
				<a href="#" class="btn-minimize"><i class="halflings-icon chevron-up"></i></a>
			</div>
		</div>
		<div class="box-content2">
			<form action="crosswalk.php?action=draw" id="" method="post">
			<fieldset>
				...
				<!--<label class="control-label" for="Coordinate">Авто замын гарц гаргах боломжит газрын координатууд</label>
				...
				<div class="inputRow2">
					<div class="inputBlock">
						...
						<input style="width: 230px;" name="title" id="Title" required="required" placeholder="Нэр, байршил (заавал бөглөнө)">
					</div>
					<div class="inputBlock">
				...
				<div class="inputRow3">
					<div class="inputBlock3">
						<input id="reset" value="Авто замын гарц гаргах боломжит газрын зураглал устгах" type="button" class="navi" />
					</div>
					<div class="inputBlock3">
...
function addSection(section) {
	$.getJSON('<?php echo MAIN_URL; ?>crosswalk.php?action=crosswalkBorder&section='+section, function(point){
