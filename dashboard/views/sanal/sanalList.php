...
<ul class="breadcrumb">
	...
	<li>
		<a href="/dashboard/news.php">Иргэдээс ирүүлсэн санал хүсэлтүүд</a>
	</li>
</ul>
...
<div class="row-fluid sortable">
	<div class="box span11">
		<div class="box-header" data-original-title>
			<h2><i class="halflings-icon pencil"></i><span class="break"></span>Иргэдээс ирүүлсэн санал хүсэлтүүд</h2>
			<div class="box-icon">
		...
		<div class="tableSearch">
			<form action="sanal.php?action=searchSanals" method="post">
			...
			<div class="searchBlock">
				<label>Санал хүсэлтийн ангилал</label>
			...
			<table width="100%" class="table table-striped table-bordered">
				<thead>
					<tr>
						<th width="5%">№</th>
						<th width="10%">Хэнээс</th>
						<th width="10%">Дүүрэг</th>
						<th width="10%">Хороо</th>
						<th width="35%">Санал, хүсэлт</th>
				...
				<tbody>
					<?php
						$k = 0; 	
						foreach($sanals as $sanal) :
						$k = $k + 1; 
					?>
					<tr>
						<td><?php echo $k; ?></td>
						<td>
						<?php echo getUserName($sanal['user_id']); ?>	
						</td>
						<td><?php echo getDistrictName($sanal['district_id']); ?></td>
						<td><?php echo getRegionName($sanal['region_id']); ?></td>
						<td><?php echo $sanal['content']; ?></td>
						<td><?php echo $sanal['sanaltype_id']; ?></td>
