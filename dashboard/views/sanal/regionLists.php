...
<div class="row-fluid sortable">
	<div class="box span11">
		<div class="box-header" data-original-title>
			<h2><i class="halflings-icon pencil"></i><span class="break"></span><?php echo $district['title'].' дүүргийн '.$region['title'].'-р хороонд ирсэн'; ?> санал хүсэлтийн жагсаалт</h2>
			<div class="box-icon">
			...
			<table width="100%" class="table table-striped table-bordered bootstrap-datatable datatable">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<a href="?action=reply&id=<?php echo $sanal['id']; ?>" class='btn btn-success'><i class="halflings-icon white edit"></i> Дэлгэрэнгүй</a>
						</td>
					</tr>
					<?php endforeach; ?>
				</tbody>
