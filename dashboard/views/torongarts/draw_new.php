	...
	<div class="box span11">
		...
		<div class="box-content">
			...
			<fieldset>
				...
				<label class="control-label" for="Coordinate">Торон гарцын тайлбар (гарчиг, нэр /Энэ нүдийг хоосон орхиж болно/)</label>
				<input name="title" id="regionId">
				
				<label class="control-label" for="Area">Торон гарцын талбайн хэмжээ /м<sup>2</sup>/</label>
