...
<ul class="breadcrumb">
	...
	<li>
		<a href="/dashboard/torongarts.php">Торон гарц гаргах боломжит газар /<?php echo $district['title'].' дүүргийн '.$region['title'].'-р хороо'; ?>/</a>
	</li>
</ul>
...
<div class="row-fluid">
	<div class="box2 span12">
		<div class="box-header" data-original-title>
			<h2><i class="halflings-icon pencil"></i><span class="break"></span><?php echo $district['title'].' дүүргийн '.$region['title'].'-р хорооны '; ?>торон гарц гаргах боломжит газар нэмэх</h2>
			<div class="box-icon">
				<a href="#" class="btn-minimize"><i class="halflings-icon chevron-up"></i></a>
			</div>
		</div>
		<div class="box-content2">
			<form action="torongarts.php?action=draw" id="" method="post">
			<fieldset>
				...
				<div class="inputRow2">
					<div class="inputBlock">
						<label>Торон гарцын тайлбар</label>
						<input style="width: 230px;" name="title" id="Title" required="required" placeholder="Торон гарцын тайлбар (заавал бөглөнө)">
					</div>
					<div class="inputBlock">
					...
					<div class="inputBlock">
						<label>Торон гарцын урт /м/</label>
						<input name="areaLength" id="AreaLength" required="required" style="width: 180px; margin-bottom: 20px;" placeholder="Торон гарцын урт /м/">
					</div>
				</div>
				<div class="inputRow3">
					<div class="inputBlock3">
						<input id="reset" value="Торон гарцын зураглал устгах" type="button" class="navi" />
					</div>
					<div class="inputBlock3">
