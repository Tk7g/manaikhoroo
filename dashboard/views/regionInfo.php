...
<div class="row-fluid row-admin">	
	<div class="quick-button metro black span2 info-box">
		...
		<div class="info-block-info">
<?php
$trash_num = Marker::countRegionMarkersAll($_SESSION['login']['district_id'], $_SESSION['login']['region_id'], 10, date('Y'));
echo $trash_num['COUNT(*)']; 
?>
		</div>
	</div>
	...
	<div class="quick-button metro yellow span2 info-box">
		...
		<div class="info-block-info">
<?php
$hospital_num = Marker::countRegionMarkersAll($_SESSION['login']['district_id'], $_SESSION['login']['region_id'], 9, date('Y'));
echo $hospital_num['COUNT(*)']; 
?>
		</div>
	</div>
	<div class="quick-button metro red span2 info-box">
...
<div class="printBtnRow2">
	<a href="javascript:window.print()" class="printBtn2"><i class="icon-print"></i> Хэвлэх</a>
</div>
<div style="padding-left: 20px;">
<?php 
include(ADMIN_TEMPLATE. "charts/population-section.php"); 
include(ADMIN_TEMPLATE. "charts/household-section.php"); 
include(ADMIN_TEMPLATE. "charts/area-section.php"); 
include(ADMIN_TEMPLATE. "charts/popdensity-section.php"); 
