			...
			<fieldset>
				...
				<div class="inputRow2">
					<div class="inputBlock">
						<label>Ногоон байгууламжийн нэр, байршил</label>
						<input style="width: 230px;" name="title" id="Title" required="required" placeholder="Ногоон байгууламжийн нэр, байршил (заавал бөглөнө)">
					</div>
					<div class="inputBlock">
					...
					<div class="inputBlock">
						<label>Ногоон байгууламжийн урт /м/</label>
