...
<div class="row-fluid sortable">
	<div class="box span11">
		...
		<div class="box-content">
			<a href="?action=adminWrite" class='quick-button-small span1'><i class="icon-plus"></i><p>Нэмэх</p></a>
				...
				<tbody>
					...
					<tr>
						...
						foreach($regionSents as $regSent) :
							...
							echo regionDistrict($region['district_id']).' дүүргийн '.$region['title'].'-р хороо, ';
						endforeach;
						...
						<td>
							<a href="?action=deleteAdmin&id=<?php echo $msg['id']; ?>" class='btn btn-danger' onclick="return confirm('<?php echo $msg['text']; ?> - мессежийг устгах уу?');"><i class="halflings-icon white trash"></i> Устгах</a>
						</td>
					</tr>
					<?php endforeach; ?>
				</tbody>
