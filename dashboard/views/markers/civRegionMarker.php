...
<div class="row-fluid sortable">
	<div class="box span11">
		...
		<video width="300" height="147" controls>
  				<source src="<?php echo MAIN_FOLDER.'/video/khoroo/irgensanal.mp4'; ?>" type="video/mp4">
  				<source src="<?php echo MAIN_FOLDER.'/video/khoroo/irgensanal.ogg'; ?>" type="video/ogg">
			...
			<table class="table table-striped table-bordered bootstrap-datatable datatable">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<?php if($_GET['action'] == civRegionMarker) { ?>
							<a href="?action=civRegionMarkerAccept&marker=<?php echo $marker['id']; ?>&region_accept=0" class='btn btn-success'><i class="halflings-icon white edit"></i> Дэлгэрэнгүй</a>
							<?php } else { ?>
							<a href="?action=civRegionMarkerDecline&marker=<?php echo $marker['id']; ?>&region_accept=1" class='btn btn-success'><i class="halflings-icon white edit"></i> Дэлгэрэнгүй</a>
							<?php } ?>
						</td>
					</tr>
					<?php endforeach; ?>
