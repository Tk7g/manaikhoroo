...
<div class="row-fluid sortable">
	<div class="box span11">
		...
		<div class="box-content">
			<form action="markers.php?action=civDistrictMarkerDecline&marker=<?php echo $marker['id']; ?>" id="saveDistrictMarker" method="post">
			<fieldset>
...
function districtMarkers(typeid, region) {
	$.getJSON('<?php echo MAIN_URL; ?>markers.php?action=civRegionMarkers1&type='+typeid+'&region='+region+'&region_accept=1', function(point){
