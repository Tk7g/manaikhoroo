...
<div class="row-fluid sortable">
	<div class="box span11">
		<div class="box-header" data-original-title>
			<h2><i class="halflings-icon edit"></i><span class="break"></span><?php echo $results['district']['title'].' дүүргийн '.$results['region']['title'].'-р хорооны зурган тэмдэглэгээ нэмэх'; ?></h2>
			<div class="box-icon">
...
<script>
	...
	$("#marker-map").css( "height", 0.8*windowHeight );
</script>
