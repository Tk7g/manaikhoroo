...
<div class="row-fluid sortable">
	<div class="box span11">
		...
		<video width="300" height="147" controls>
  				<source src="<?php echo MAIN_FOLDER.'/video/district/dzurag.mp4'; ?>" type="video/mp4">
  				<source src="<?php echo MAIN_FOLDER.'/video/district/dzurag.ogg'; ?>" type="video/ogg">
		...
		<div class="box-content">
			...
			?>
			<a href="markers.php?action=districtAdd&type=<?php echo $result['typeid']; ?>">
