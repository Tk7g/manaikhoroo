...
<div class="row-fluid sortable">
	<div class="box span11">
		...
		<div class="box-content">
			<form action="markers.php?action=civRegionMarkerAccept&marker=<?php echo $marker['id']; ?>" id="saveDistrictMarker" method="post">
			<fieldset>
...
function districtMarkers(typeid) {
	$.getJSON('<?php echo MAIN_URL; ?>markers.php?action=civRegionMarkers&type='+typeid+'&region_accept=0', function(point){
