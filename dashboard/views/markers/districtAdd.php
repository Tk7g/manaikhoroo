<?php
	$current_district = District::getDistrict($_SESSION['login']['district_id']);
...
<div class="row-fluid sortable">
	<div class="box span11">
		...
		<div class="box-content">
			<form action="markers.php?action=saveDistrict&type=<?php echo $type['id']; ?>" id="saveDistrictMarker" method="post">
			<fieldset>
...
function saveDesc() {
	$.ajax({
		...
		type:"post", 
		url:"<?php echo MAIN_URL; ?>markers.php?action=saveDesc&type="+<?php echo $type['id']; ?>
	});
	infoWindow.close(map);
...
function saveLocation() {
	$.ajax({
		...
		success:function (data, textStatus) {
			location.href = 'http://manaikhoroo.ub.gov.mn/dashboard/markers.php?action=districtAdd3&type=<?php echo $type['id']; ?>&id='+data;
		},
		type:"post", 
		url:"<?php echo MAIN_URL; ?>markers.php?action=saveDistrict&type="+<?php echo $type['id']; ?>
	});
	marker = null;
	infoWindow.close(map);
	districtMarkers(<?php echo $type['id']; ?>);
