		...
		<div class="box-content2">
			...
			<fieldset>
				...
				<div class="inputRow2">
					...
					<div class="inputBlock">
						<label>Бүсийн урт /м/</label>
						<input name="areaLength" id="AreaLength" required="required" style="width: 180px; margin-bottom: 20px;" placeholder="Бүсийн урт /м/">
					</div>
				</div>
				<div class="inputRow3">
					<div class="inputBlock3">
						<input id="reset" value="Үерийн аюултай бүсийн зураглал устгах" type="button" class="navi" />
					</div>
					<div class="inputBlock3">
