...
/**
  ...
  */
function getOptimalClassInformation ($values, $minimumNumberOfClasses = 3, $maximumNumberOfClasses = 4) {
	// Make sure our values are sorted
	array_multisort($values);
...
function displayGoogleMap($values, $locations, $map_type, $return_data = false) {
	...
	$class_information = getOptimalClassInformation($values, 4);
...
<?php 
	displayGoogleMap(array(192, 212.4, 216, 226.6, 237, 294, 364, 565.5), array(17, 25, 18, 19, 20, 21, 22, 23), 'usa');
?>
